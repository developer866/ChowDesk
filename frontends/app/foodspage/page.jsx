...
export default function FoodsPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      {/* Toast notification */}
      {toast && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-sm font-medium px-5 py-3 rounded-full shadow-lg flex items-center gap-2 font-(family-name:--font-body) animate-slideDown z-50">
